    ...
    public class SerialPortsPool : IDisposable
    {
        ...
        private void port_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            if (DataReceived != null)
            {
                ...
                DataReceived(sender, new SerialPortDataEventArgs(((SerialPort)sender).PortName, data));
            }
        }
        ...
        private void port_ErrorReceived(object sender, SerialErrorReceivedEventArgs e)
        {
            if (ErrorReceived != null)
                ErrorReceived(sender, new SerialPortErrorEventArgs(((SerialPort)sender).PortName, e.EventType));
        }
